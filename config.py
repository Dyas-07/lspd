...
# Certifique-se de que estas variáveis de ambiente estão definidas em seu .env ou no Railway.
...
TICKET_MESSAGES_FILE = 'ticket_messages.json' # Arquivo que contém as mensagens e embeds para o sistema de tickets

# Nome do arquivo do banco de dados SQLite
DATABASE_NAME = 'punch_card.db'

# ID do Cargo Autorizado (para comandos administrativos gerais, como !mascote, !relatorio, !forcereport)
